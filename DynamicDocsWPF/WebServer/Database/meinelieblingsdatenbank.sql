...
CREATE TABLE IF NOT EXISTS `archivepermission` (
  ...
  CONSTRAINT `archivepermission_ibfk_1` FOREIGN KEY (`PROCESS_ID`) REFERENCES `runningprocess` (`ID`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `entry` (
  ...
  CONSTRAINT `entry_ibfk_1` FOREIGN KEY (`PROCESS_ID`) REFERENCES `runningprocess` (`ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
